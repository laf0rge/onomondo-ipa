...
extern asn_CHOICE_specifics_t asn_SPC_RetrieveNotificationsListResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RetrieveNotificationsListResponse_1[2];
extern asn_per_constraints_t asn_PER_type_RetrieveNotificationsListResponse_constr_1;
