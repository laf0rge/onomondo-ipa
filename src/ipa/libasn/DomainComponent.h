...
oer_type_decoder_f DomainComponent_decode_oer;
oer_type_encoder_f DomainComponent_encode_oer;
per_type_decoder_f DomainComponent_decode_uper;
per_type_encoder_f DomainComponent_encode_uper;
