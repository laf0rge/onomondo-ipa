...
oer_type_decoder_f UniqueIdentifier_decode_oer;
oer_type_encoder_f UniqueIdentifier_encode_oer;
per_type_decoder_f UniqueIdentifier_decode_uper;
per_type_encoder_f UniqueIdentifier_encode_uper;
