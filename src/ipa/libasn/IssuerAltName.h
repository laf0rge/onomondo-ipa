...
oer_type_decoder_f IssuerAltName_decode_oer;
oer_type_encoder_f IssuerAltName_encode_oer;
per_type_decoder_f IssuerAltName_decode_uper;
per_type_encoder_f IssuerAltName_encode_uper;
