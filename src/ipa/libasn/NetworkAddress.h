...
oer_type_decoder_f NetworkAddress_decode_oer;
oer_type_encoder_f NetworkAddress_encode_oer;
per_type_decoder_f NetworkAddress_decode_uper;
per_type_encoder_f NetworkAddress_encode_uper;
