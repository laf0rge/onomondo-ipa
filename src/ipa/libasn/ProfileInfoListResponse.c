...
static asn_oer_constraints_t asn_OER_type_ProfileInfoListResponse_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_ProfileInfoListResponse_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ProfileInfoListResponse_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_ProfileInfoListResponse_specs_1 = {
