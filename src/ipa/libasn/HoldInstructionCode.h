...
oer_type_decoder_f HoldInstructionCode_decode_oer;
oer_type_encoder_f HoldInstructionCode_encode_oer;
per_type_decoder_f HoldInstructionCode_decode_uper;
per_type_encoder_f HoldInstructionCode_encode_uper;
