...
oer_type_decoder_f InvalidityDate_decode_oer;
oer_type_encoder_f InvalidityDate_encode_oer;
per_type_decoder_f InvalidityDate_decode_uper;
per_type_encoder_f InvalidityDate_encode_uper;
